...
import sixpack from "./images/sixpack.png";
    ...
    return (
        <>
                        ...
                        <div className="carousel-item active">
                            ...
                            <div className="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                <div className="p-3" style={{ MaxWidth: "900px" }}>
                                    ...
                                    <a href="" className="btn btn-danger py-md-3 px-md-5 me-3">Join Us</a>
            ...
            <div class="container-fluid p-5">
                <div class="row gx-5">
                    <div class="col-lg-5 mb-5 mb-lg-0" style={{ MaxWidth: "500px" }}>
                    ...
                    <div class="col-lg-7">
                        <div class="mb-4">
                            <h5 class="text-danger text-uppercase">About Us</h5>
                            <h1 class="display-4 text-uppercase mb-0">Welcome to Gymster</h1>
                        </div>
                        ...
                        <div class="rounded bg-dark p-5 ">
                            <ul class="nav nav-pills justify-content-between mb-3 red ">
                                <li class="nav-item w-50 ">
                                    <a class="nav-link text-uppercase  w-100 active" data-bs-toggle="pill" href="#pills-1">  About Us</a>
                                </li>
                                <li class="nav-item w-50 ">
                                    <a class="nav-link text-uppercase w-100 " data-bs-toggle="pill" href="#pills-2" >Why Choose Us</a>
                                </li>
                            </ul>
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="pills-1">
                                    <p class="text-secondary mb-0"> <b> Tempor erat elitr at rebum at at clita aliquyam consetetur. Diam dolor diam ipsum et, tempor voluptua sit consetetur sit. Aliquyam diam amet diam et eos sadipscing labore. Clita erat ipsum et lorem et sit, sed stet no labore lorem sit. Sanctus clita duo justo et tempor consetetur takimata eirmod, dolores takimata consetetur invidunt magna dolores aliquyam dolores dolore. Amet erat amet et magna </b></p>
                                </div>
                ...
                <div class="row g-5 gb-5">
                    <div class="col-lg-4 col-md-6">
                        <div class="bg-light rounded text-center p-5">
                            ...
                            {/* <img src={sixpack} alt="" style={{Color:"red"}} /> */}
                            <img src={sixpack} alt="" style={{ Color: "red" }} />
                            ...
                            <a class="text-uppercase text-danger" href="">Read More <BsArrowRight /></a>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="bg-light rounded text-center p-5">
                    ...
                    <div class="col-lg-12 col-md-6 text-center">
                        ...
                        <a href="" class="btn btn-danger py-3 px-5 ">Become A Member</a>
                    </div>
                </div>
            </div>
            {/* <!-- Programe Start --> */}
            ...
            <div class="container-fluid p-5">
                <div class="mb-5 text-center">
                    <h5 class="text-danger text-uppercase">Class Schedule</h5>
                            ...
                            <div class="row g-5">
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        ...
                                        <h5 class="text-uppercase text-danger">Power Lifting</h5>
                                        <p class="text-uppercase text-light mb-0"> John Deo  </p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">8.00am - 10.00am</h6>
                                        <h5 class="text-uppercase text-danger">Body Building</h5>
                                        <p class="text-uppercase text-light mb-0">James Taylor</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">10.00am - 12.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Cardio Program</h5>
                                        <p class="text-uppercase text-light mb-0">Jack Sparrow</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">12.00pm - 2.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Weight Loose</h5>
                                        <p class="text-uppercase text-light mb-0">Robert Smith</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">2.00pm - 4.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Fitness Program</h5>
                                        <p class="text-uppercase text-light mb-0">Adam Phillips</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">4.00pm - 6.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Crossfit Class</h5>
                                        <p class="text-uppercase text-light mb-0">James Alien</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">6.00pm - 8.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Muscle Building</h5>
                                        <p class="text-uppercase text-light mb-0">Petter John</p>
                                    </div>
                                </div>
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="bg-dark rounded text-center py-5 px-3">
                                        <h6 class="text-uppercase text-light mb-3">8.00pm - 10.00pm</h6>
                                        <h5 class="text-uppercase text-danger">Yoga Class</h5>
                                        <p class="text-uppercase text-light mb-0">Jessy Reo</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid bg-dark facts p-5 my-5">
                <div class="row gx-5 gy-4 py-5">
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex">
                            <div class="bg-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style={{ Width: "60px", Height: " 60px" }}>
                                <i class="fa fa-star fs-4 text-white m-3"></i>
                            </div>
                            <div class="ps-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex">
                            <div class="bg-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style={{ Width: "60px", Height: " 60px" }}>
                                <i class="fa fa-users fs-4 text-white m-3" ></i>
                            </div>
                            <div class="ps-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex">
                            <div class="bg-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style={{ Width: "60px", Height: " 60px" }}>
                                <i class="fa fa-check fs-4 text-white m-3"></i>
                            </div>
                            <div class="ps-4">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="d-flex">
                            <div class="bg-danger rounded-circle d-flex align-items-center justify-content-center mb-3" style={{ Width: "60px", Height: " 60px" }}>
                                <i class="fa fa-coffee text-white m-3"></i>
                            </div>
                            <div class="ps-4">
                ...
                <div class="row g-0">
                    <div class="col-lg-6" style={{ MinHeight: "500px" }}>
                        <div class="position-relative h-100">
                            ...
                            <img class="position-absolute w-100 h-100" src={testimonial1} style={{ ObjectFit: "cover" }} />
                        </div>
                    </div>
                    <div class="col-lg-6 bg-dark p-5">
                        <div class="mb-5">
                            <h5 class="text-danger text-uppercase">Testimonial</h5>
                            <h1 class="display-4 text-uppercase text-light mb-0">Our Client Say</h1>
                        </div>
                        <div class="owl-carousel testimonial-carousel">
                            <div class="testimonial-item">
                                <p class="fs-5 fw-normal text-light mb-4">
                                    <i class="fa fa-quote-left text-danger me-3"></i>
                                    Dolores sed duo clita tempor justo dolor et stet lorem kasd labore dolore lorem ipsum. At lorem lorem magna ut et, nonumy et labore et tempor diam tempor erat dolor rebum sit ipsum.</p>
                                <div class="d-flex align-items-center">
                                    {/* <img class="img-fluid rounded-circle" src="img/testimonial-1.jpg" alt=""/> */}
                                    <img class="img-fluid rounded-circle" src={testimonial3} alt="" width={"80px"} />
                                    <div class="ps-4">
                            ...
                            <div class="testimonial-item mt-3" >
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <img class="img-fluid rounded-circle" src={testimonial2} alt="" width={"80px"} />
                                    <div class="ps-4">
                                        <h5 class="text-uppercase text-light">Client Name</h5>
                                        <span class="text-uppercase text-secondary">Profession</span>
                                    </div>
            ...
            <div class="container-fluid p-5">
                <div class="mb-5 text-center">
                    <h5 class="text-danger text-uppercase">Our Blog</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="blog-item">
                            ...
                            <div class="bg-dark d-flex align-items-center rounded-bottom p-4">
                                ...
                                <h5 class="h5 text-uppercase text-light" href="">Sed amet tempor amet sit kasd sea lorem</h5>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
